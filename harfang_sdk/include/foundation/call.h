...
template <typename R> struct future_call : future_call_base {
...
template <typename R> struct future_call_with_return_value_base : future_call_base {
	virtual std::future<R> get_future() = 0;
};

// future call with return value
template <typename R> struct future_call_with_return_value;

template <> struct future_call_with_return_value<void> : future_call_with_return_value_base<void> {
...
template <typename R> struct future_call_with_return_value : future_call_with_return_value_base<R> {
