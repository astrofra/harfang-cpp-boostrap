...
inline bool AlmostEqual(const Vector3 &a, const Vector3 &b, float epsilon) { return types::Abs(a.x - b.x) < epsilon && types::Abs(a.y - b.y) < epsilon && types::Abs(a.z - b.z) < epsilon; }

/*!
	@short Vector base to Euler.
	@note base convention u = {0,0,1}, v = {1,0,0}, second axis is optional.
*/
static void BaseToEuler(Vector3 &euler, Vector3 &u, Vector3 *v = nullptr);
...
/// Vector distance.
inline float Dist(const Vector3 &a, const Vector3 &b) { return math::Sqrt(Dist2(a, b)); }
