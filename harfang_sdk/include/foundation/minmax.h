...
inline bool Overlap(const MinMax &a, const MinMax &b, math::Axis axis) { return !(b.mn[axis] > a.mx[axis] || b.mx[axis] < a.mn[axis]); }
...
inline MinMax Union(const MinMax &a, const MinMax &b) { return MinMax(Vector3::Minimum(a.mn, b.mn), Vector3::Maximum(a.mx, a.mx)); }
